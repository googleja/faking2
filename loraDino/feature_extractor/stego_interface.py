...
from loraDino.stego.data import create_cityscapes_colormap
...
class StegoInterface:
    def __init__(
        ...
        device: str,
        input_size: int = 224,
        # model_path: str = f"/home/jack/wvn/self_supervised_segmentation/models/stego_cocostuff27_vit_base_5_cluster_linear_fine_tuning.ckpt",
        model_path: str = f"/home/jack/wvn/self_supervised_segmentation/models/zzy_refactor.ckpt",
        ...
        # pretrained_weights = torch.load(self._cfg.model_path, map_location='cuda:0')
        # compare_weights = torch.load(f"/home/jack/wvn/self_supervised_segmentation/models/zzy_refactor.ckpt")
        # print(pretrained_weights['state_dict']['backbone.model.cls_token']==compare_weights['state_dict']['backbone.model.cls_token'])

        # 跳过lora层的参数,导入stego
        self._model = Stego.load_from_checkpoint(self._cfg.model_path, n_image_clusters=self._cfg.n_image_clusters, strict=False)
...
def run_stego_interfacer():
    ...
    from loraDino.stego.stego import remove_axes
